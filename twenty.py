...
def explore_location():
    ...
    locations = ["Mysterious Cave", "Haunted Forests", "Deserted Beach", "Ancient Ruins"]
    ...
    save_to_file(IVENTORY_FILE, treasure)
    return treasure
...
def update_leaderboard(player_name, score):
    ...
    save_to_file(LEADERBOARD_FILE, f"{player-name}: {score}")
    ...
    while True:
        ...
        if choice == "1":
            ...
            print(f"You added (treasure) to your inventory!")
                ...
                print(f"You colleceted {score} treasure.")
